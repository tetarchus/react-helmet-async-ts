module.exports = {
  ...
  settings: {},
  rules: {
    // Enforce all elements that require alternative text have meaningful information to relay
    //  back to end user
    // https://github.com/jsx-eslint/eslint-plugin-jsx-a11y/blob/HEAD/docs/rules/alt-text.md
    // TODO: Add custom elements as required
    'jsx-a11y/alt-text': [
      'error',
      {
    ...
    // TODO: Add additional input components here
    'jsx-a11y/autocomplete-valid': ['error', { inputComponents: ['Input', 'FormField'] }],
    ...
    // TODO: Add additional heading components here
    ...
    // TODO: Check docs and potentially add more to tabbable
    ...
    // TODO: Add custom label details below
    ...
    // TODO: Add custom media types below
    ...
    // Enforce that the `accessKey` prop is not used on any element to avoid complications with
    //  keyboard commands used by a screenreader
    ...
    // Enforce that non-interactive, visible elements (such as `<div>`) that have click handlers
